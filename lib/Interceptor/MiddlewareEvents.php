...
namespace SecurityTestPeru\Client\Interceptor;
...
use \SecurityTestPeru\Client\Interceptor\KeyHandler;
use \SecurityTestPeru\Client\Interceptor\MyLogger;
use \SecurityTestPeru\Client\Model\Errors;
use \SecurityTestPeru\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\SecurityTestPeru\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \SecurityTestPeru\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \SecurityTestPeru\Client\Model\Errores(["errors" => [$error]]);
